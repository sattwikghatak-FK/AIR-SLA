...
st.divider()
if st.button("🚀 Run Air SLA Mapper Engine") and file1 and file2 and file3 and file4:
    try:
        # Use Streamlit's Status Container for UI Feedback
...
elif st.button("🚀 Run Air SLA Mapper Engine"):
